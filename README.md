...
- **Remote Work**: Remote positions show a clear compensation premium, with salaries rising fastest as experience increases
- **Industry Trends**: smaller sectors like healthcase and computer system designs offer competitive salaries
...
```bash
git clone https: https://github.com/MartaVeinberga/Stackoverflow-Data-Survey-Analysis.git
cd Stackoverflow-Data-Survey-Analysis
```
2. Run the Jupyter notebook to generate visualizations.
